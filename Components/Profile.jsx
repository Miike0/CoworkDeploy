        ...
        <div className="profile-container">
            ...
            <Container className="profile-data-container">
                <Row className="profile-about">
                    ...
                    <Col xs={7} className="profile-about-me">
                        <span className="profile-about-me-name">John Doe</span>
                        <p className="profile-about-me-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas exercitationem at maiores, aspernatur cupiditate sint facilis repellendus blanditiis, doloremque velit vero? Reprehenderit nemo impedit inventore, dolor voluptatibus vero illo recusandae!</p>
                    </Col>
                    <Col xs={3} className="profile-actions">
                        <Col xs={3} className="profile-actions-more">
                            <Button variant="outlined" className="profile-actions-more-btn button">
                                <MoreHorizOutlinedIcon fontSize="medium"/>
                            </Button>
                        </Col>
                        <Col xs={2.5} className="profile-actions-message">
                            <Button variant="outlined" className="profile-actions-message-btn button">
                                Mensaje
                            </Button>
                        </Col>
                        <Col xs={2.5} className="profile-actions-follow">
