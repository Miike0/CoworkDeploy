            ...
            <Container className="profile-data-container">
                <Row className="profile-about">
                    <Col md="auto" className="profile-about-avatar">
                        <Avatar
                            alt="JohnDoe"
                            sx={isDesktop ? { width: 160, height: 160 } : { width: 100, height: 100 }}
                            src={userPic}
                    ...
                    <Col xs={isDesktop ? 7 : 10} className="profile-about-me">
                    ...
                    <Col xs={isDesktop ? 3 : 15} className="profile-actions">
                        <Col xs={isDesktop ? 3 : 4} className="profile-actions-more">
                            <Button variant="outlined" className="profile-actions-more-btn button">
                                <MoreHorizOutlinedIcon fontSize="medium"/>
                            </Button>
                        </Col>
                        <Col xs={isDesktop ? 2.5 : 5} className="profile-actions-message">
                            <Button variant="outlined" className="profile-actions-message-btn button">
                                Mensaje
                            </Button>
                        </Col>
                        <Col xs={isDesktop ? 2.5 : 2} className="profile-actions-follow">
